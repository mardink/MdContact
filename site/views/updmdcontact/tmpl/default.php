...
?>
    ...
    <form class="form-validate" action="<?php echo JRoute::_('index.php'); ?>" method="post" id="updmdcontact" name="updmdcontact">
		<fieldset>
        	<dl>
                ...
                <dt></dt><dd></dd>
                <dt></dt>
            	<dd><input type="hidden" name="option" value="com_mdcontact" />
            	    <input type="hidden" name="task" value="updmdcontact.submit" />
                </dd>
                <dt></dt>
