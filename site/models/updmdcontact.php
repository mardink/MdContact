 ...
 * UpdMdContact Model
 */
class MdContactModelUpdMdContact extends JModelForm
{
	/**
	 * @var object item
	 */
	...
	public function getForm($data = array(), $loadData = true)
	{
        ...
        // Get the form.
		$form = $this->loadForm('com_mdcontact.updmdcontact', 'updmdcontact', array('control' => 'jform', 'load_data' => true));
		if (empty($form)) {
			return false;
		}
		return $form;
	...
	function &getItem()
	{
		...
		if (!isset($this->_item))
		{
			$cache = JFactory::getCache('com_mdcontact', '');
			$id = $this->getState('mdcontact.id');
